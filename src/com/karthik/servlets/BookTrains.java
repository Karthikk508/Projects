...
import com.karthik.beans.TrainBean;
import com.karthik.beans.TrainException;
import com.karthik.constant.ResponseCode;
import com.karthik.constant.UserRole;
import com.karthik.service.BookingService;
import com.karthik.service.TrainService;
import com.karthik.service.impl.BookingServiceImpl;
import com.karthik.service.impl.TrainServiceImpl;
import com.karthik.utility.TrainUtil;
...
//			date = outputFormat.format(utilDate);
			...
			// Parse the input journeyDate string and format it as 'yyyy-MM-dd' for the database
			
		    DateTimeFormatter inputFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		    LocalDate parsedJourneyDate = LocalDate.parse(journeyDate, inputFormatter);

		    // Store the parsed date in 'yyyy-MM-dd' format
		    String date = parsedJourneyDate.toString(); 
